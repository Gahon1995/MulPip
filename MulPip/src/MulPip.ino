...
//主要运行任务定义
Task tDisplay(0.001 * TASK_SECOND, TASK_FOREVER, MyDisplay, &ts, true);	//显示任务
...
#define  _TIME   READ_TIME * TASK_SECOND
//机器控制任务，未启用
Task tConPIP1(_TIME, TASK_FOREVER, controlPIP1, NULL, false, NULL, FinishPIP1);
Task tConPIP2(_TIME, TASK_FOREVER, controlPIP2, NULL, false, NULL, FinishPIP2);
Task tConPIP3(_TIME, TASK_FOREVER, controlPIP3, NULL, false, NULL, FinishPIP3);
...
volatile long countpip1 = 0L;	//运行过程中初始为1，需要消去
volatile long countpip2 = 0L;
volatile long countpip3 = 0L;
